  ...
  return (
    <div className={darkMode ? "dark" : ""} >
      ...
      <link rel="icon" href="/favicon.ico" type="image/x-icon" />
        <main className='bg-white text-black text-md py-5 leading-8 overflow-hidden md:text-xl px-10 md:px-20 lg:px-40  dark:bg-gray-700'>
            <section className='min-h-screen'>
              ...
              <div className='text-4xl flex justify-center gap-12 py-3 text-gray-600 dark:text-gray-400'>
              ...
              <div className='relative mx-auto ml-2 bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 mt=20 overflow-hidden md:h-96 md:w-96'>
            ...
            <section> 
              <div>
                ...
                <p className='text-md py-2 leading-8 text-gray-800 dark:text-white'>I am a Full Stack Software Developer using <span className='text-teal-500'>LAMPP Stack</span>(Linux, Apache, MySQL, PHP, & Python) for my whole development process. As a Front End developer I am convient with <span className='text-teal-500'>HTML 5, CSS 3, Javascript, Bootstrap 4, Semantics UI, Tailwind CSS, Vue Js, and React</span>. Also I am very convinient with Back End Development as well having my strong hold on <span className='text-teal-500'>PHP, MySQL, and Laravel a PHP framework</span>.</p>
