        ...
        <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
            ...
            <section>
              <div>
                ...
                <p className='text-md py-2 leading-8 text-gray-800'>Since the beginning of my journey as a web developer, I have done remote work for<span className='text-teal-500'>agencies</span>consulted for<span className='text-teal-500'>start ups</span>and collaborated with talented people to create digital products for both digital and consumer use.</p>
                <p className='text-md py-2 leading-8 text-gray-800'>I offer from a wide range of services, including programming of desktop and mobile systems, database managment,and web deployment</p>
              </div>
